...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at
   [`cthoyt/sssom-curator`](https://github.com/cthoyt/sssom-curator) on your
   GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with `git clone https://github.com/<your namespace here>/sssom-curator.git`
...
```shell
$ git remote add cthoyt https://github.com/cthoyt/sssom-curator.git
```
